...
/*
    ...
    Cmdline:
        sokol-shdc -i source\shader.glsl.preprocessed -o source/gen__shader.odin -l hlsl5 -f sokol_odin
...
/*
    ...
    {
        float4 param = color;
        float4 param_1 = float4(0.5f, 0.5f, 0.5f, 1.0f);
...
fs_source_hlsl5 := [746]u8 {
    ...
    0x6f,0x61,0x74,0x34,0x28,0x30,0x2e,0x35,0x66,0x2c,0x20,0x30,0x2e,0x35,0x66,0x2c,
